...
- position1 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The position of the first vertex.
- color1 (const [DGL_Color](Types.md/#dgl_color)*) - The color of the first vertex.
- textureOffset1 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The texture coordinate of the first vertex.
- position2 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The position of the second vertex.
- color2 (const [DGL_Color](Types.md/#dgl_color)*) - The color of the second vertex.
- textureOffset2 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The texture coordinate of the second vertex.
- position3 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The position of the third vertex.
- color3 (const [DGL_Color](Types.md/#dgl_color)*) - The color of the third vertex.
- textureOffset3 (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The texture coordinate of the third vertex.
...
- position (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The position of the vertex.
- color (const [DGL_Color](Types.md/#dgl_color)*) - The color of the vertex.
- textureOffset (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The texture coordinate of the vertex.
...
- mesh (const [DGL_Mesh](Types.md/#dgl_mesh)*) - The mesh to use for drawing.
- mode ([DGL_DrawMode](Types.md/#dgl_drawmode)) - The drawing mode to use.
...
- [DGL_Mesh](Types.md/#dgl_mesh)
- [DGL_DrawMode](Types.md/#dgl_drawmode)
...
- [DGL_Mesh](Types.md/#dgl_mesh)* - The pointer to the new mesh. If unsuccessful, the pointer will be NULL.
...
- mesh ([DGL_Mesh](Types.md/#dgl_mesh)**) - The address of the mesh pointer to be freed.
...
- texture ([DGL_Texture](Types.md/#dgl_texture)**) - The address of the texture pointer to be freed.
...
- [DGL_Texture](Types.md/#dgl_texture)
...
- [DGL_Texture](Types.md/#dgl_texture)* - A pointer to the new texture. If unsuccessful, this will be NULL.
...
- color (const [DGL_Color](Types.md/#dgl_color)*) - Address of a [DGL_Color](Types.md/#dgl_color) variable containing the color to set the background to.
...
- mode ([DGL_BlendMode](Types.md/#dgl_blendmode)) - The blend mode to use.
...
- [DGL_BlendMode](Types.md/#dgl_blendmode)
...
- textureOffset (const [DGL_Vec2](Types.md/#dgl_vec2)*) - A pointer to a [DGL_Vec2](Types.md/#dgl_vec2) variable containing the texture offset coordinates to use.
...
- color (const [DGL_Color](Types.md/#dgl_color)*) - Address of a [DGL_Color](Types.md/#dgl_color) variable containing the color to set the tint to.
...
- position (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The address of a [DGL_Vec2](Types.md/#dgl_vec2) variable containing the world position.
- scale (const [DGL_Vec2](Types.md/#dgl_vec2)*) - The address of a [DGL_Vec2](Types.md/#dgl_vec2) variable containing the scale in the X and Y directions.
...
- transformationMatrix (const [DGL_Mat4](Types.md/#dgl_mat4)*) - A pointer to a [DGL_Mat4](Types.md/#dgl_mat4) variable which contains the transformation matrix to use.
...
- mode ([DGL_ShaderMode](Types.md/#dgl_shadermode)) - The shader mode to use when drawing a mesh.
...
- [DGL_ShaderMode](Types.md/#dgl_shadermode)
...
- texture ([DGL_Texture](Types.md/#dgl_texture)) - The texture to use when drawing a mesh.
...
- sampleMode ([DGL_TextureSampleMode](Types.md/#dgl_texturesamplemode)) - The texture sample mode to use.
- addressMode ([DGL_TextureAddressMode](Types.md/#dgl_textureaddressmode)) - The texture address mode to use.
...
- [DGL_TextureSampleMode](Types.md/#dgl_texturesamplemode)
- [DGL_TextureAddressMode](Types.md/#dgl_textureaddressmode)
